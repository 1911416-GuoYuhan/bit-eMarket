...
<!--      </el-table-column>-->
    ...
    <div style="margin-left: 20%; margin-top: 10px;">
      <el-input v-model="input" placeholder="请输入评论" style="width: 50%;height: 40px"></el-input>
      <el-button @click="addComment" style="background-color: #266720;color: white;font-weight: bold;font-size: 20px">评论</el-button>
    </div>
