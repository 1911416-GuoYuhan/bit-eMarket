    ...
    <div class="goods-add-form">
      ...
      <el-form :model="goods" :rules="rules" ref="goods" label-width="100px" class="demo-ruleForm" style="margin-top: 50px;">
        ...
        <el-form-item label="商品名称" prop="name">
          <el-input v-model="goods.name" class="input"></el-input>
        </el-form-item>

        <el-form-item label="商品价格" prop="price">
            <el-input v-model="goods.price" class="input"></el-input>
        </el-form-item>

        <el-form-item label="原价">
          <el-input v-model="goods.realPrice" class="input"></el-input>
        </el-form-item>
        ...
        <el-form-item label="商品类型" prop="type">
          <div class="input">
            <el-select v-model="goods.type" placeholder="请选择" class="input">
              <el-option
        ...
        <el-form-item>
          <el-button @click="submitGoodsForm" style="background-color: #266720;font-size: 20px;font-weight: bold;color: white">立即创建</el-button>
          <el-button @click="" style="background-color: #c3c3c3;font-size: 20px;font-weight: bold;color: white">重置</el-button>
        </el-form-item>
      </el-form>
