    ...
    <div class="user-sign-in">
      ...
      <el-form :model="userSignIn">
        ...
        <el-form-item label="用户名" :label-width="formLabelWidth">
          <el-input v-model="userSignIn.username" auto-complete="off" class="input"></el-input>
        </el-form-item>

        <el-form-item label="密码" :label-width="formLabelWidth">
          <el-input type="password" v-model="userSignIn.password" auto-complete="off" class="input"></el-input>
        </el-form-item>

        <el-form-item >
          <el-checkbox v-model="userSignIn.power">管理员</el-checkbox>
        </el-form-item>
